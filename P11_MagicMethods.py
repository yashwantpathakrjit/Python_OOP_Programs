...
if __name__ == '__main__':
    YASHWANT = Employee('YASHWANT', 'Pathak', 1000)
    Jagdish = Employee('Jagdish','MAKHIJANI', 2000)
    print(YASHWANT)                # Full Name: YASHWANT Pathak (This output because of __str__ method overloading)
    print(Jagdish)              # Full Name: Jagdish MAKHIJANI
    print(YASHWANT + Jagdish)      # 3000 (This output because of __add__ method overloading)
    print(YASHWANT * Jagdish)      # 2000000 (__mul__)
    print(int(YASHWANT))           # 1000 (__int__)
    print(int(Jagdish))         # 2000 (__int__)
    print(YASHWANT==Jagdish)
